...
const { resetsessions } = require("./resetsessions_c.js")
...
const {usermod} = require('./admin/usermod_c.js')
const {users} = require('./admin/users_c.js')
const {sessionupd} = require('./admin/sessionupd_c.js')
program
    .version("1.0.0")
    .description("CLI")
//COMMANDS - SCOPE
